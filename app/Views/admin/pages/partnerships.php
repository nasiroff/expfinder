...
<?= $this->include('admin/parts/sidebar') ?>
    ...
    <div class="content-wrapper">
                        ...
                        <div class="card-header header-elements-inline">
                            ...
                            <div class="header-elements">
                                <div class="form-check form-check-right form-check-switchery form-check-switchery-sm">
                                    <a href="<?= route_to("App\Controllers\Admin\Partnership::new") ?>" class="btn btn-outline alpha-success text-success-800 border-success-600">
                                        Yeni partniyor yarat
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <!-- /content area -->
        <div id="dialog-form" title="Partniyora baxış">
            <div class="content">
                    ...
                    <div class="col-md-12">
                        <div class="card-body">
                            <form action="#" id="updateForm">
                                <input type="hidden" id="partnership_id" name="id">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text"  id="title"  name="title" required class="form-control" placeholder="Başlıq">
                                ...
                                <div class="col-lg-3 offset-md-2 partnership-photo">
                                    <div class="card">
                                        <div class="card-img-actions mx-1 mt-1">
                                            <img class="card-img img-fluid" id="partnership_img" src="" alt="">
...
<script src="<?= base_url("global_assets/js/demo_pages/self_partnership_dialog_box.js") ?>"></script>
<?php if (session()->has('success')): ?>
    <script>
