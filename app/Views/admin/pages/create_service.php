                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="registrationForm"
                                  action="<?= route_to('App\Controllers\Admin\Service::create') ?>"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="number" name="price" value="<?= old('price') ?>" min="0" required
                                               step=".01" class="form-control" placeholder="Qiymət">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <textarea rows="5" name="description" id="editor-full" cols="5"
                                                  class="form-control"
                                                  placeholder="Məhsulun təsviri"><?= old('description') ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
...
<?= $this->section('js_codes') ?>
    <script src="<?= base_url("global_assets/js/demo_pages/self_create_service_validator.js") ?>"></script>
    <script src="<?= base_url("global_assets/js/demo_pages/self_create_service.js") ?>"></script>
<?php if (session()->has('success')): ?>
    <script>
