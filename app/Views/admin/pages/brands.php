...
<div class="content-wrapper">
  ...
  <!-- /content area -->
  <div id="dialog-form" title="Brendə baxış">
    <div class="content">
          ...
          <div class="card-body">
            <form action="#" id="updateForm">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-10">
                  <input type="text" id="name" name="name" required class="form-control" value="" placeholder="Ad">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <textarea rows="5" name="about" cols="5" class="form-control"
                              placeholder="Haqqında"></textarea>
                </div>
              </div>


              <div class="col-lg-3 offset-md-2 brand-photo">
                <div class="card">
                  <div class="card-img-actions mx-1 mt-1">
                    <img class="card-img img-fluid" id="brand_img" src="">
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-start flex-nowrap">
                      <div class="list-icons list-icons-extended ml-auto">
                        <a href="javascript:;" id="delete-img" class="list-icons-item"><i
...
<script src="<?=base_url("global_assets/js/demo_pages/self_brand_dialog_box.js")?>"></script>
<?php if(session()->has('success')): ?>
  <script>
